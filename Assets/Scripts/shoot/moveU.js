...
function Update () {
	...
	transform.rotation = new Quaternion(Random.Range(transform.rotation.x-0.03,transform.rotation.x+0.01),
										Random.Range(transform.rotation.y-0.03,transform.rotation.y+0.01),
										Random.Range(transform.rotation.z-0.03,transform.rotation.z+0.01),
										Random.Range(transform.rotation.w-0.03,transform.rotation.w+0.01));
}